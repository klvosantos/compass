...
#docker exec ${CONTAINER_NAME} awslocal sqs create-queue --queue-name partial-queue || { echo "Failed to create partial-queue"; exit 1; }
#docker exec ${CONTAINER_NAME} awslocal sqs create-queue --queue-name full-queue || { echo "Failed to create full-queue"; exit 1; }
#docker exec ${CONTAINER_NAME} awslocal sqs create-queue --queue-name excess-queue || { echo "Failed to create excess-queue"; exit 1; }
#
